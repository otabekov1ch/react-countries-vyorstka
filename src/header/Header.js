    ...
    return (
        ...
        <header className="site-header">
            <div className="site-header__container container">
                <h1 className="site-header__heading">Where in the world?</h1>
                <button className="site-header__mode-btn js-mode-toggler">
                    <span className="site-header__mode-btn-inner">
                        <span className="site-header__mode-img">
                        ...
                        <span className="site-header__mode-btn-txt">Dark Mode</span>
                    </span>
                </button>
            </div>
        </header>
